import svgPaths from "@/imports/svg-e86oxqyiv1";
...
export function DemoButton({
  ...
  return (
    <a
      ...
      className={`bg-white content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[30px] py-[10px] relative rounded-[35px] no-underline transition-transform hover:scale-105 cursor-pointer ${className}`}
    >
      <p
        className="font-['Rubik',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#5f80c9] text-[16px] text-right"
        dir="auto"
      >
        {text}
      </p>
