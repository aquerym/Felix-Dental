...
export const ruLayout = {
  ...
  hero: { containerWidth: "md:w-full", subtitleMaxW: "md:max-w-[680px]", itemsAlign: "items-end", buttonsFirst: false as const, ctaFirst: true as const, marginTop: "-mt-[70px]", frame12Width: "md:w-[790px]", titleWidth: "min-w-full", heroTextGap: "gap-[10px]", buttonsDirection: "flex-col md:flex-row", buttonsAlign: "items-end md:items-center justify-center", logoMobileMargin: "ml-0" },
